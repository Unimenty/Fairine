...
export const products: Product[] = [
    {
        ...
        variants: [
            { volume: '1L', price: 14, bulkPackSize: 8, image: '/assets/liquid-soap-1l.webp' },
            { volume: '4L', price: 50, bulkPackSize: 4, image: '/assets/liquid-soap-4l.webp' }
        ],
        inStock: true,
        featured: true,
        rating: 4.8,
    ...
    },
    {
        ...
        variants: [
            { volume: '1L', price: 16, bulkPackSize: 8, image: '/assets/floor-cleaner-1l.webp' },
            { volume: '5L', price: 65, bulkPackSize: 4, image: '/assets/floor-cleaner-5l.webp' }
        ],
        inStock: true,
        featured: true,
        rating: 4.9,
    ...
    },
    {
        ...
        variants: [
            { volume: '500ml', price: 13, bulkPackSize: 12, image: '/assets/afterwash-500ml.webp' },
            { volume: '1L', price: 30, bulkPackSize: 10, image: '/assets/afterwash-1l.webp' }
        ],
        inStock: true,
        featured: true,
        rating: 4.8,
    ...
    },
    {
        ...
        variants: [
            ...
            { volume: '750ml', price: 27, bulkPackSize: 10, image: '/assets/shower-gel-750ml.webp' }
        ],
        inStock: true,
        featured: true,
        rating: 4.7,
